...
/*   Updated: 2022/01/06 10:10:11 by pniva            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define L90	(int[8]) {0,0, 1,0, 2,0, 0,1}
# define L180	(int[8]) {0,0, 1,0, 1,1, 1,2}
# define L270	(int[8]) {2,0, 0,1, 1,1, 2,1}
# define J		(int[8]) {1,0, 1,1, 0,2, 1,2}
# define J90	(int[8]) {0,0, 0,1, 1,1, 2,1}
# define J180	(int[8]) {0,0, 1,0, 0,1, 0,2}
# define J270	(int[8]) {0,0, 1,0, 2,0, 2,1}
# define T		(int[8]) {0,0, 1,0, 2,0, 1,1}
# define T90	(int[8]) {1,0, 0,1, 1,1, 1,2}
# define T180	(int[8]) {1,0, 0,1, 1,1, 2,1}
# define T270	(int[8]) {0,0, 0,1, 1,1, 0,2}
# define Z		(int[8]) {0,0, 1,0, 1,1, 2,1}
# define Z90	(int[8]) {1,0, 0,1, 1,1, 0,2}
